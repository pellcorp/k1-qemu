...
if [ -f ${TARGET_DIR}/usr/sbin/nginx ]; then
    ...
    if [ -f ${TARGET_DIR}/etc/init.d/S50nginx ]; then
        mv ${TARGET_DIR}/etc/init.d/S50nginx ${TARGET_DIR}/etc/init.d/X50nginx 
    fi
