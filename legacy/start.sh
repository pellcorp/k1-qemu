...
#chown $USER image.qcow2 initrd.img vmlinux
...
qemu-system-mipsel -machine malta -cpu 4KEc -m 2G -drive file=image.qcow2 -kernel vmlinux -initrd initrd.img $NET_DEV $NET_DEVICE -nographic -append "root=LABEL=rootfs console=ttyS0,115200"
